...
def open_change_master_popup():
    ...
    def verify_and_change():
        ...
        new_entry = ctk.CTkEntry(new_pw_popup, width=250, placeholder_text="New Password", show="*")
        new_entry.pack(pady=5)
        confirm_entry = ctk.CTkEntry(new_pw_popup, width=250, placeholder_text="Confirm New Password", show="*")
