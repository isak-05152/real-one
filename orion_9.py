...
def show_login_window():
    ...
    toggle_btn = ctk.CTkButton(frame, text="👁 ", width=80, command=tflash_visibility)
...
def show_platform_window():
    ...
    logout_btn = ctk.CTkButton(top_frame, width=40, text="⏻ ", fg_color="#F54927", hover_color="#F54927", text_color="white", command=logout)
