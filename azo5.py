...
login_frame = ctk.CTkFrame(root, width=900, height=600,fg_color="transparent")
...
ctk.CTkLabel(login_frame, text="🔐", font=("Arial", 48)).pack(pady=(30, 5))
ctk.CTkLabel(login_frame, text="Password Manager", font=("Arial", 22, "bold"), text_color="#2B2B2B").pack()
ctk.CTkLabel(login_frame, text="Enter your master password to continue", font=("Arial", 12), text_color="black").pack(pady=(4, 20))

ctk.CTkFrame(login_frame, height=1, fg_color="blue", width=400).pack()

pw_row = ctk.CTkFrame(login_frame, fg_color="transparent")
pw_row.pack(pady=15)
login_password_entry = ctk.CTkEntry(
    pw_row, width=290, placeholder_text="Master Password", show="*",
    height=40, corner_radius=10, border_color="#AAAAAA", border_width=1,
...
toggle_btn = ctk.CTkButton(
    pw_row, text="👁", width=40, height=40, corner_radius=10,
    fg_color="#E0E0E0", hover_color="#CCCCCC", text_color="#333333",
    command=tflash_visibility
)
toggle_btn.pack(side="left", padx=(6, 0))

ctk.CTkButton(
    login_frame, text="Unlock Vault", command=unlock_vault,
    width=150, height=42, corner_radius=10,
    fg_color="#2C6E49", hover_color="#1F4D34", text_color="white",
    font=("Arial", 14, "bold")
).pack(padx=(0, 15))
...
ctk.CTkButton(plat_top_frame, text="🛡️", width=40, command=open_change_master_popup).pack(side="right", padx=5)
...
ctk.CTkButton(acc_top_frame, text="🛡️",width=40,command=open_change_master_popup).pack(side="right",padx=5)
